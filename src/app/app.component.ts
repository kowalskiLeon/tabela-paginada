...
export class AppComponent {
  ...
  public lista2 = [['Maria', '28', 'Belo Horizonte', 'Pará de Minas'], ['Claudio', '26', 'São Paulo', 'São Paulo'], ['Sandro', '34', 'Niterói', 'Rio de Janeiro', 'teste'],
  ['Maria', '28', 'Belo Horizonte', 'Pará de Minas'], ['Claudio', '26', 'São Paulo', 'São Paulo'], ['Sandro', '34', 'Niterói', 'Rio de Janeiro', 'teste'],
  ['Maria', '28', 'Belo Horizonte', 'Pará de Minas'], ['Claudio', '26', 'São Paulo', 'São Paulo'], ['Sandro', '34', 'Niterói', 'Rio de Janeiro', 'teste']];
