...
export class AppComponent {
  ...
  ['Ana', '28', 'Belo Horizonte', 'Ipatinga'], ['Otavio', '32', 'São Paulo', 'São Paulo'], ['Sandro', '34', 'Niterói', 'Rio de Janeiro'],
  ['Eva', '27', 'Betim', 'Azurita'], ['Otavio', '32', 'São Paulo', 'Jundiaí'], ['Sandro', '34', 'Niterói', 'Rio de Janeiro'],
  ['Otavio', '25', 'Contagem', 'Florestal'], ['Otavio', '32', 'São Paulo', 'São Paulo'], ['Sandro', '34', 'Niterói', 'Rio de Janeiro'],
